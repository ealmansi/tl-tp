...
En los lenguajes C y C++, el punto y coma (;) es un terminador de \emph{statements}. El mismo es necesario por múltiples razones. Por un lado, en estos lenguajes es posible yuxtaponer sentencias que se pretende ejecutar en consecuencia, pero que también forman una sentencia válida si se las concatena. Por ejemplo:
...
El proceso de creación del compilador MyLanga nos permitió ver un caso real del uso de grámaticas para reconocer código de un lenguaje concreto. Además del uso de técnicas vistas en clase como TDS y ASTs, nos llevó a enfrentar (si bien de manera simplificada) cuestiones comunes como son los scopes, las tablas de símbolos, el stack, etc. Otro aspecto fue la declaratividad de los errores, que implicó pensar la sintaxis de la mayor cantidad posible de errores comunes.